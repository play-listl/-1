document.addEventListener('DOMContentLoaded', function() {
    ...
    const points = {
        'Telephone': [20, 12, 8, 6, 4, 3, 2, 0],
        'Light Bulb': [16, 16, 11, 7, 5, 4, 2, 1],
        'Airplane': [12, 12, 14, 9, 7, 5, 3, 2],
        'Television': [10, 10, 11, 12, 8, 6, 4, 4],
        'Penicillin': [8, 8, 8, 9, 11, 8, 5, 5],
        'Personal Computer': [6, 6, 7, 7, 8, 10, 7, 5],
        'Internet': [5, 5, 5, 6, 7, 9, 9, 7],
        'Smartphone': [4, 4, 4, 4, 5, 6, 7, 8]
    };

    const correctOrder = [
        { city: 'Telephone', year: '1876' },
        { city: 'Light Bulb', year: '1879' },
        { city: 'Airplane', year: '1903' },
        { city: 'Television', year: '1927' },
        { city: 'Penicillin', year: '1928' },
        { city: 'Personal Computer', year: '1981' },
        { city: 'Internet', year: '1989' },
        { city: 'Smartphone', year: '2007' }
    ];
